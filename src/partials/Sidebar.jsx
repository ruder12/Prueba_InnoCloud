...
import LogoEmpresa from './iconSvg/LogoEmpresa';
    ...
    <div>
      ...
      >
        ...
        <div className="flex justify-between mb-10 pr-3 sm:px-2">
          ...
          {/* Logo */}
          <NavLink end to="/" className="block flex flex-row">
            <LogoEmpresa /> Ruder
          </NavLink>
        </div>
                ...
                >
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex flex-shrink-0 ml-2">
                      <span className="inline-flex items-center justify-center h-5 text-xs font-medium text-white bg-indigo-500 px-2 rounded">1</span>
                    </div>
                  </div>
                </NavLink>
              </li>
